...
%\begin{itemize}
%	\item Rm (wytrzymałość na rozciąganie):
%	\begin{itemize}
%	\begin{outline}
%		\item liczba zdjęć reprezentujących niską wytrzymałość wzrosła z 65 do 1397,
%		\item liczba zdjęć reprezentujących wysoką wytrzymałość wzrosła ze 158 do 3400,
%		\item łączna liczba zdjęć wzrosła z 223 do 4757,
%		\item 24 zdjęcia miały przybliżenie 500x, 199 zdjęć miało przybliżenie 100x;
%	\end{itemize}
%	\item Rp (granica sprężystości):
%	\begin{itemize}
%		\item liczba zdjęć w tym przypadku również średnio wzrosła aż dwudziestokrotnie
%	\end{itemize}
%\end{itemize}
