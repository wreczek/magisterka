...
\end{figure}
Porównując te tablicę pomyłek do poprzedniej, która dotyczyła wyników badań przeprowadzonych na wszystkich danych możemy dojść do kilku ciekawych wniosków. Aczkolwiek na samym początku wskazane jest, aby wyjaśnić tak drastyczne spadki skuteczności dla klasy "0". Otóż jak pokazano w rozdz. \ref{wycinanie.struktur}, liczba struktur klasy "0"~wynosi zaledwie 14 i została dodana przez autora pracy. Stąd została całkowicie zignorowana przez model. 
Oprócz tego, głównie na dokłaności straciła klasa III, bo aż 28 punktów procentowych. Natomiast zyskały klasy I-II oraz V-VI, które są najbardziej do siebie podobne.
